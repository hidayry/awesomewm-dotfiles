...
return function(s)
    ...
    local function notif_panel()
        local icon = wibox.widget({
            markup = helpers.ui.colorize_text("󰂞", beautiful.white),
            align = "center",
            valign = "center",
    ...
    local function clip()
        local clip_icon = wibox.widget({
            markup = helpers.ui.colorize_text("󰅎", beautiful.white),
            align = "center",
            valign = "center",
    ...
    local function terminal()
        local term_icon = wibox.widget({
            markup = helpers.ui.colorize_text("󰆍", beautiful.white),
            align = "center",
            valign = "center",
            font = beautiful.material_icons .. " 14",
            widget = wibox.widget.textbox
    ...
    local function files()
        local file_icon = wibox.widget({
            markup = helpers.ui.colorize_text("󰉋", beautiful.white),
            align = "center",
            valign = "center",
            font = beautiful.material_icons .. " 14",
            widget = wibox.widget.textbox
    ...
    local function code()
        local code_icon = wibox.widget({
            markup = helpers.ui.colorize_text("󰘐", beautiful.white),
            align = "center",
            valign = "center",
            font = beautiful.material_icons .. " 14",
            widget = wibox.widget.textbox
