...
local function autostart_apps()
	...
	helpers.run.check_if_running("picom", nil, function()
		awful.spawn("picom --config " .. config_dir .. "configuration/picom.conf -b", false)
	end)
  ...
  --- Polkit Agent
	helpers.run.run_once_pgrep("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1")
	--- clipboard
