...
function take_screenshot_with_timer(timer)
  ...
  awful.spawn.easy_async_with_shell("sleep " .. timer .. " && maim -u ~/Pictures/" .. screenshot_name, function()
...
function take_fullscreen_screenshot()
  local screenshot_name = "screenshot_" .. os.date("%Y-%m-%d_%H-%M-%S") .. ".png"
  awful.spawn.easy_async_with_shell("maim ~/Pictures/" .. screenshot_name, function()
      local delete_screenshot = naughty.action {
          name = 'Delete Screenshot',
          icon_only = false,
      }
...
function take_selected_area_screenshot()
  local screenshot_name = "screenshot_" .. os.date("%Y-%m-%d_%H-%M-%S") .. ".png"
  awful.spawn.easy_async_with_shell("maim -s ~/Pictures/" .. screenshot_name, function()
      local delete_screenshot = naughty.action {
          name = 'Delete Screenshot',
          icon_only = false,
      }
