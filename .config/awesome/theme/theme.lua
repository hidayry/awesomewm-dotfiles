...
theme.wallpaper = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/26.jpg")
--theme.wallpaper = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/20.jpg")
...
theme.awesome_dock_pinned = {
    {"firefox"}, {"nemo"}, {"telegram-desktop"},
    {"simplescreenrecorder"}, {"gnome-terminal"}, {"nautilus"}, {"gimp"},
    {"inkscape"}, {apps.default.music_player}, {"rawtherapee"}, {"gnome-software"}
}
theme.awesome_dock_color_active = theme.accent
theme.awesome_dock_color_inactive = theme.fg_normal .. "66"
theme.awesome_dock_color_minimized = theme.accent .. "33"
theme.awesome_dock_color_hover = theme.fg_normal .. "33"
...
theme.dont_swallow_classname_list = {
    "firefox", "gimp", "brave-browser", "Thunar", "microsoft-edge",
}
